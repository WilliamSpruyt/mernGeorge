      ...
      <Modal {...this.props} show={true} dialogClassName="custom-modal"   >
        ...
        <img
          ...
          <form>
            ...
            <Button type="submit" disabled={(this.props.qvalue<1 || this.props.timevalue<1)} variant="contained" color={(this.props.qvalue>1 && this.props.timevalue>=1)?"primary":"default"} size="large" onClick={(this.props.qvalue>1 && this.props.timevalue>=1)?this.props.onSubmit:null}>
            Start
          </Button>
          </form>
